        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-2">
            ...
            <ul className="space-y-1.5 text-xs">
              <li><button onClick={() => setActivePage('prediction')} className="hover:text-emerald-400 transition-colors">Symptom Checker</button></li>
              <li><button onClick={() => setActivePage('prediction')} className="hover:text-emerald-400 transition-colors">Visual AI Scanner</button></li>
